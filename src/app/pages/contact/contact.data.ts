const jobsOpenings = [

    {
      ...
      description: " Developing new user-facing features using Angular, HTML & CSS Building self-contained, reusable, and testable modules and components Debug existing source code and polish feature sets and review code by peers  Analyze the needs of clients and then develop a system to meet those requirements ",
